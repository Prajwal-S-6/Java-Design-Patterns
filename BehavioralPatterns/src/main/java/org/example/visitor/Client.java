...
public class Client {
	...
	public static void main(String[] args) {
		...
		visitEmployees(employee, printVisitor);
	}
	...
	private static void visitEmployees(Employee employee, Visitor visitor) {
		employee.accept(visitor);
		employee.getDirectReports().forEach(e -> visitEmployees(e, visitor));
	}
